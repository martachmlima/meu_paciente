...
function ModalEditAppointments({ isOpen, onClose, obj }) {
  const { user } = useAuth()
  const { handleEditAppointment } = useUser()
  ...
  const handleAppointment = data => {
    ...
    handleEditAppointment(data, obj)
    onClose()
  }
...
export default ModalEditAppointments
